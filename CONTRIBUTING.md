# Contributing to Golang Tutorial
...
2. If you've changed Concept, update the documentation.
3. Make sure you used proper comments to explain the concept
4. Make sure your code is clean.
...
- check previous code in repository to get idea
